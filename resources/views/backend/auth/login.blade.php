...
<head>
    ...
    <title>Coding Is Beautiful | Admin</title>
    ...
    <div class="row no-gutters flex-row-reverse ht-100v">
        <div class="col-md-6 bg-gray-200 d-flex align-items-center justify-content-center">
            <div class="login-wrapper wd-250 wd-xl-350 mg-y-30">
                ...
                <p class="tx-center mg-b-60">Please enter your credentials here.</p>
        ...
        <div class="col-md-6 bg-br-primary d-flex align-items-center justify-content-center">
            <div class="wd-250 wd-xl-450 mg-y-30">
                <div class="signin-logo tx-28 tx-bold tx-white"><span class="tx-normal">[</span> Coding Is <span
                        class="tx-info">Beautiful</span> <span class="tx-normal">]</span></div>
                <div class="tx-white mg-b-60">Welcome Back Sir, Please login to continue !</div>
