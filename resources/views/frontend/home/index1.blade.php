            ...
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div class="products-slider owl-carousel owl-theme dots-top dots-small m-b-1 pb-1 appear-animate"
                        ...
                        @foreach (App\Models\Product::orderBy('id', 'desc')->get()->take(6) as $product)
                            <div class="product-default inner-quickview inner-icon">
                                <figure class="img-effect">
                                    <a href="demo1-product.html">
                                        <img src="{{ url('products/' . json_decode($product->images)[0]) }}"
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title"> <a
                                            href="{{ url('products/details/' . $product->id) }}">{{ $product->name }}</a>
                                    </h3>
                                    ...
                                    <div class="price-box">
                                        <span class="product-price">MMK{{ $product->discount_price }}</span>
                                    </div>
                                    <!-- End .price-box -->
                                </div>
                                <!-- End .product-details -->
                        ...
                        <nav class="side-nav">
                            <ul class="menu menu-vertical sf-arrows">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        @foreach (App\Models\Category::orderBy('name', 'asc')->where('cat_id', null)->get() as $category)
                                            <li>
                                                <a href="#">{{ $category->name }}</a>
                                                <ul>
                                                    @foreach ($category->subcategories as $subcategory)
                                                        <li><a
                                                                href="{{ url('/products/all?cat_ids%5B%5D=' . $subcategory->id) }}">{{ $subcategory->name }}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </li>
                                ...
                                <li>
                                    <a href="#" class="sf-with-ul"><i class="sicon-star"></i>Brands</a>

                                    <ul>
                                        @foreach (App\Models\Brand::orderBy('name', 'asc')->get() as $brand)
                                            <li>
                                                <a
                                                    href="{{ url('/products/all?brand_ids%5B%5D=' . $brand->id) }}">{{ $brand->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{ url('products/all') }}" class="sf-with-ul"><i
                                            class="sicon-basket"></i>Products</a>
                                </li>
                                <li>
                                    <a href="{{ url('order/cart') }}" class="sf-with-ul"><i
                                            class="sicon-basket"></i>Cart</a>
                                </li>
                                <li>
                                    <a href="{{ url('order/checkout') }}" class="sf-with-ul"><i
                                            class="sicon-basket"></i>Checkout</a>
                                </li>
                                <li>
                                    <a href="{{ url('register') }}" class="sf-with-ul"><i
                                            class="icon-user-2"></i>Register</a>
                                </li>
                                <li>
                                    <a href="{{ url('/login') }}" class="sf-with-ul"><i
                                            class="icon-user-2"></i>Login</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="widget widget-banners px-3 pb-3 text-center">
                        <div class="owl-carousel owl-theme dots-small">
                            ...
                            <div class="banner banner4">
                                <figure>
                                    <img src="{{ asset('frontend/') }}/assets/images/demoes/demo1/banners/banner-7.jpg"
                                        alt="banner">
                                </figure>
                                ...
                                <div class="banner-layer">
                                    <div class="coupon-sale-content">
                                        ...
                                        <a href="demo1-shop.html"
                                            class="btn btn-inline-block btn-dark btn-black ls-0">VIEW
                                            SALE</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="owl-carousel owl-theme dots-left dots-small">
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="{{ asset('frontend/') }}/assets/images/clients/client-1.jpg"
                                            alt="client">
                                    </figure>
                            ...
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="{{ asset('frontend/') }}/assets/images/clients/client-2.jpg"
                                            alt="client">
                                    </figure>
                            ...
                            <div class="testimonial">
                                <div class="testimonial-owner">
                                    <figure>
                                        <img src="{{ asset('frontend/') }}/assets/images/clients/client-3.jpg"
                                            alt="client">
                                    </figure>
