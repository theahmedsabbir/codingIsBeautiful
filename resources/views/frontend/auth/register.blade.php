                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-7 mx-0 mx-xl-auto no-pd">
                                ...
                                <form class="form" method="post" action="{{ route('register') }}"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 mx-auto mt-3">
                                                    {{-- title --}}
                                                    <h3 class="register_title text-center mb-3">Join Our Community
                                                    </h3>

                                                    {{-- name --}}
                                                    <div class="form-group">
                                                        <label for="name" class="text-capitalize mb-2">name</label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="btn imageInput" for="imageInput"
                                                            id="imageInputLabel">Choose a image</label>
                                                        <input type="file" class="image-input"
                                                            style="visibility: hidden; width: 100%;" id="imageInput"
                                                        ...
                                                        {{-- <label for="avatar" class="text-capitalize mb-2">avatar</label>
                                    ...
                                    <div class="buttons">
                                        ...
                                        <button class="btn btn-primary post_submit" type="submit">Register</button>
                                        <button class="btn btn-primary post_submit second_button">Login</button>
                                    </div>
                                </form>
                            </div>
                        </div>
